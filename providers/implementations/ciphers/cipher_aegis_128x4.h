#include "include/crypto/aegis_128x4.h"
#include "prov/ciphercommon.h"

#define AEGIS_128X4_KEYLEN 16
#define AEGIS_128X4_IVLEN 16
#define AEGIS_128X4_RATE 128

typedef struct {
    PROV_CIPHER_CTX base; /* must be first */
    unsigned char state[8 * AEGIS_128X4_RATE / 2];
    unsigned char key[16];
    unsigned char tag[32];
    unsigned char buf[AEGIS_128X4_RATE];
    uint64_t ad_len;
    uint64_t msg_len;
    size_t pos;
    size_t tag_len;
} PROV_AEGIS_128X4_CTX;
