/* aegis-128x4 cipher implementation */
...
static inline aes_block_t AES_BLOCK_XOR(const aes_block_t a, const aes_block_t b)
{
    return (aes_block_t){ _mm_xor_si128(a.b0, b.b0), _mm_xor_si128(a.b1, b.b1),
                          _mm_xor_si128(a.b2, b.b2),
                          _mm_xor_si128(a.b3, b.b3) };
}
...
static inline aes_block_t AES_BLOCK_AND(const aes_block_t a, const aes_block_t b)
{
    return (aes_block_t){ _mm_and_si128(a.b0, b.b0), _mm_and_si128(a.b1, b.b1),
                          _mm_and_si128(a.b2, b.b2),
                          _mm_and_si128(a.b3, b.b3) };
}
...
static inline aes_block_t AES_ENC(const aes_block_t a, const aes_block_t b)
{
    return (aes_block_t){ _mm_aesenc_si128(a.b0, b.b0),
                          ...
                          _mm_aesenc_si128(a.b2, b.b2),
                          _mm_aesenc_si128(a.b3, b.b3) };
}
...
{
    return (aes_block_t){ vld1q_u8(a), vld1q_u8(a + 16), vld1q_u8(a + 32),
                          vld1q_u8(a + 48) };
}
                                             ...
                                             const aes_block_t b)
{
    return (aes_block_t){ softaes_block_xor(a.b0, b.b0),
                          ...
                          softaes_block_xor(a.b2, b.b2),
                          softaes_block_xor(a.b3, b.b3) };
}
                                             ...
                                             const aes_block_t b)
{
    return (aes_block_t){ softaes_block_and(a.b0, b.b0),
                          ...
                          softaes_block_and(a.b2, b.b2),
                          softaes_block_and(a.b3, b.b3) };
}

static ossl_inline aes_block_t AES_BLOCK_LOAD(const uint8_t *a)
{
    return (aes_block_t){ softaes_block_load(a), softaes_block_load(a + 16),
                          softaes_block_load(a + 32),
                          softaes_block_load(a + 48) };
}
...
static ossl_inline aes_block_t AES_ENC(const aes_block_t a, const aes_block_t b)
{
    return (aes_block_t){ softaes_block_encrypt(a.b0, b.b0),
                          ...
                          softaes_block_encrypt(a.b2, b.b2),
                          softaes_block_encrypt(a.b3, b.b3) };
}
...
static const PROV_CIPHER_HW_AEGIS_128X4 aegis_128x4_hw = {
...
const PROV_CIPHER_HW *ossl_prov_cipher_hw_aegis_128x4(size_t keybits)
{
# if defined(__x86_64__) || defined(_M_X64)
#  if defined(__VAES__) && defined(__AVX512F__)
    const int is_vaes_capable = 1;
    const int is_avx512f_capable = 1;
#  else
    const int is_vaes_capable = (OPENSSL_ia32cap_P[3] & (1u << 9)) != 0;
    const int is_avx512f_capable = (OPENSSL_ia32cap_P[2] & (1u << 16)) != 0;
#  endif
    if (is_vaes_capable && is_avx512f_capable) {
        return ossl_prov_cipher_hw_aegis_128x4_avx512(keybits);
    }
...
#  endif
    if (is_vaes_capable && is_avx2_capable) {
        return ossl_prov_cipher_hw_aegis_128x4_vaes(keybits);
    }
# endif

    return (PROV_CIPHER_HW *)&aegis_128x4_hw;
}
