...
static OSSL_FUNC_cipher_settable_ctx_params_fn aegis_128l_settable_ctx_params;
#define aegis_128l_gettable_params ossl_cipher_generic_gettable_params
static OSSL_FUNC_cipher_update_fn aegis_128l_update;
...
static const OSSL_PARAM aegis_128l_settable_ctx_params_list[] = {
    OSSL_PARAM_size_t(OSSL_CIPHER_PARAM_KEYLEN, NULL),
    OSSL_PARAM_size_t(OSSL_CIPHER_PARAM_IVLEN, NULL),
...
static const OSSL_PARAM *aegis_128l_settable_ctx_params(ossl_unused void *cctx,
    ossl_unused void *provctx)
{
    return aegis_128l_settable_ctx_params_list;
}
...
static int aegis_128l_update(void *vctx, unsigned char *out, size_t *outl,
    ...
    size_t outsize, const unsigned char *in, size_t inl)
{
    ...
    if (in == NULL)
        return aegis_128l_final(vctx, out, outl, outsize);

    return aegis_128l_update(vctx, out, outl, outsize, in, inl);
}
